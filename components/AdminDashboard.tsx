            ...
            <div className="lg:col-span-2 space-y-6">
              {selectedVideo ? (
                <>
                  ...
                  {/* Delete Button */}
                  <div className="bg-red-900/10 p-6 rounded-xl border border-red-900/50 flex justify-between items-center hover:bg-red-900/20 transition-colors duration-300">
                    <div>
